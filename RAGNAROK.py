...
bot = telebot.TeleBot('7888977015:AAG9zrTsJKD5G8mL1lvEosd-go4VrCzkDoo')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, \n✨✨Premium \nAttack STARTED 🚀 BY HELLA.\n\n📡 𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n🔌 𝐏𝐨𝐫𝐭: {port}\n⏱️ 𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n\n𝐌𝐞𝐭𝐡𝐨𝐝: Premium \nBy https://t.me/+zwVMuLrc_XhiZTI1"
    bot.reply_to(message, response)
